...
- Renovate dependency policy is inherited from the org-level shared config; model changes should not add a repo-local Renovate config unless a repo-specific override is required.
